...
$Server = "mysql-primary.private.loadtest.commonapp.net"
$UserID = "ca4app"
$PWD = "6czy67yWp^%n"
$Database = "CACloud_prod"
$Query = "select ScreenId from Screen where DeleteStatus = 0"
$ConnectionStringValue = "Server=$Server;Uid=$UserID;Pwd=$PWD;database=;$Database"
