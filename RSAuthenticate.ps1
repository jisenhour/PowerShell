    $email = "jisenhour@commonapp.org" # Use the Email Address for your RightScale User in the Dashboard
    $passwd = "Gijoe2015" # Your User's password
    $account = "79775" # Your RightScale Account ID, easily obtained via Dashboard navigation
